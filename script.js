  ...
  try {
    const res = await fetch(FORM_ENDPOINT, {
      ...
      body: JSON.stringify({
        ...
        _subject: `Maintenance schedule request — ${fd.get('company')} — YieldGuard`,
        _template: 'table',
        _captcha: 'false',
      }),
    });
    ...
    formError.textContent = 'Transmission failed. Please contact us directly at contact@yieldguard.ro.';
